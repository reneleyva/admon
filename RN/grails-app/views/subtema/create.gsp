    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="container-fluid">
                ...
                <div id="create-subtema" class="content scaffold-create" role="main">
                    <h1 class="text-center"><strong>Nuevo subtema</strong></h1>
                    <!-- Nueva linea -->
                    <hr size="10" style="color: #5C946E;"/>
                    ...
                    <g:form url="[resource:subtemaInstance, action:'save']" >
                        <fieldset class="form">
