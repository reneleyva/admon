    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="container-fluid">
                ...
                <div id="edit-subtema" class="content scaffold-edit" role="main">
                    <h1 class="text-center"><strong>Editar subtema</strong></h1>
                    <!-- Nueva linea -->
                    <hr size="10" style="color: #5C946E;"/>  
                    ...
                    <g:hasErrors bean="${subtemaInstance}">
                        <ul class="errors" role="alert">
                            <g:eachError bean="${subtemaInstance}" var="error">
                                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                            </g:eachError>
                        </ul>
                    </g:hasErrors>
                    
                    <g:form url="[resource:subtemaInstance, action:'update']" method="PUT" >
                        <g:hiddenField name="version" value="${subtemaInstance?.version}" />
                        <fieldset class="form">
