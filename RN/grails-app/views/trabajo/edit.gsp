...
<!-- Contendor -->
        <div class="container">
            ...
            <div class="container-fluid">
                ...
                <div id="edit-trabajo" class="content scaffold-edit" role="main">
                    <h1 class="text-center"><strong>Editar trabajo</strong></h1>
                <!-- Nueva linea -->
                    <hr size="10" style="color: #5C946E;"/>              <g:if test="${flash.message}">
                    ...
                    <g:form url="[resource:trabajoInstance, action:'update']" method="PUT" >
                        <g:hiddenField name="version" value="${trabajoInstance?.version}" />
                        <fieldset class="form">
